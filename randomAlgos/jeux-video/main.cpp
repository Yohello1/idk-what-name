...
int main()
{
	...
	Shaders::computeImageOut sheWasVeryMeanOhWell(1024,1024,4);
	Shaders::computeImageIn heyworld(1024,1024,2);
	Shaders::computeImageIn letItGo(1024,1024,1);              // Not used
...
//		scene1._transforms->rotateView(0.5,0.5,0.5);
		...
		inMyMind.useProgram();
		glBindTextureUnit(4, sheWasVeryMeanOhWell.getID());
		glUniform1i(glGetUniformLocation(inMyMind.shaderProgram, "delta"), 0);
