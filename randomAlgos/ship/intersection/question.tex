...
Now your job is to take the information given, and make a function called `scrap_metal_amt_calc`, which will take the locations of the planets, and it's radius as two seperate lists. Then return the amount of scrap metal needed as an integer (round up).
