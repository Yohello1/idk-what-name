...
int main()
{
   ...
   std::cout << "Start  pressure: " << start_pressure << "\nEnd    pressure: " << end_pressure << '\n'
             << "Total difference " << end_pressure - start_pressure << '\n';
   // scr_dump();
   excecution_finished();
}
...
void smoke_move()
{
   ...
   */
   ...
   //          // std::cout << "Target Pressure" << target_pressure << '\n';
