...
/*
The purpose of this script is to make "fixed_pos" objects, or object that will not and cannot move however will be interacted with this
This is like passive thing
 */
...
int main()
{
    ...
    // Let's get a basic blue box
    for(int x_pos= 0; x_pos < LOGICAL_WINDOW_WIDTH; x_pos++){
      for(int y_pos = 0; y_pos < LOGICAL_WINDOW_WIDTH; y_pos++){
	if(x_pos > 120 && x_pos < 128 && y_pos < 120)
	  {
