...
// #include "generation/terain.hpp" // these will be added back after the purge
...
int main()
{
	...
	render::Scene theScene("Gament", 1024,1024,1024,1024, vertices, indices);



	// past this will be thrown into the Scene library
	...
	while (theScene.getEnd())
	{
		theScene.update(indices);
